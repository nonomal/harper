...
<svg {width} {height} viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<rect id="obsidian-logo-bg" fill="#262626" width="512" height="512" rx="100" />
	<g filter="url(#obsidian-filter-a)">
		<path
